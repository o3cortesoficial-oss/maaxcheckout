...
function StorefrontPreview({ settings, products, productImages, compact = false }) {
  ...
  return (
    ...
    >
      ...
      <section className="fresh-store-intro"><h2>{settings.intro_left}</h2><span>{settings.intro_right}</span></section>
      ...
      <section className="fresh-store-story"><article><small>O QUE DIZEM SOBRE NÓS</small><h3>“{settings.testimonial_quote}”</h3><p>{settings.testimonial_text}</p><span>Cliente verificado</span></article><div>{editorialImage ? <img src={editorialImage} alt="Produto em destaque" /> : <Package />}</div></section>

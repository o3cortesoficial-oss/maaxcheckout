  ...
  return <div className="home-page">
    <section className="hero shell-dark">
      ...
      <div className="hero-grid">
        <div className="hero-copy reveal"><span className="eyebrow dark"><i/> Checkout brasileiro, sem atrito</span><h1>Venda mais.<br/>Complique <em>menos.</em></h1><p>Crie checkouts que passam confiança, recebem via Pix e cartão e transformam visitas em receita.</p><div className="hero-actions"><Btn onClick={()=>go('/login')}>Começar agora <ArrowRight size={17}/></Btn><a href="#recursos">Ver como funciona</a></div></div>
